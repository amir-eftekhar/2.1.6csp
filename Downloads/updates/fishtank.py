...
class FishTank(tk.Tk):
  ...
  def __init__(self):
    ...
    tank_picture = os.path.join(dirname, 'tank.png')
    # tank.PNG does not exist teh correct file path is tank.png
...
#   no instance of the class is made so we need to make an instance of the class and call the monitor funciton in order for the fishtank gui to show
fishtank = FishTank()
fishtank.monitor()
# in order to keep the window open
fishtank.mainloop()